...
($jscomp.polyfill = function (t, e, n, a) {
    ...
    ($jscomp.polyfillIsolated = function (t, e, n, a) {
        ...
        (r = r[r.length - 1]),
            null !=
                (e = e(
                    (n = $jscomp.IS_SYMBOL_NATIVE && "es6" === n ? a[r] : null)
                )) &&
                (t
                    ...
                    : e !== n &&
                      (($jscomp.propertyToPolyfillSymbol[r] =
                          $jscomp.IS_SYMBOL_NATIVE
    ...
    (function (n) {
        ...
        function B(t) {
            ...
            I.__browser ||
                ...
                n.remove()),
                j.extend(t.oBrowser, I.__browser),
                (t.oScroll.iBarWidth = I.__browser.barWidth);
        }
        function o(t, e, n, a, r, o) {
            var i,
                l = !1;
            for (n !== R && ((i = n), (l = !0)); a !== r; )
                t.hasOwnProperty(a) &&
        ...
        function U(t, e) {
            ...
            t.aoColumns.push(n),
                ((n = t.aoPreSearchCols)[a] = j.extend(
                    {},
                    I.models.oSearch,
                    n[a]
                )),
        ...
        function V(t, e, n) {
            ...
            var a,
                ...
                i =
                    (e.sWidthOrig ||
                        ...
                        (a = (o.attr("style") || "").match(
                            /width:\s*(\d+[pxem%]+)/
                        )) && (e.sWidthOrig = a[1])),
                    n !== R &&
                        null !== n &&
                        ($(n),
                        v(I.defaults.column, n, !0),
            ...
            (n = function (t) {
                ...
                (t = -1 !== j.inArray("asc", e.asSorting)),
                (n = -1 !== j.inArray("desc", e.asSorting)),
                e.bSortable && (t || n)
                    ? t && !n
        ...
        function b(t, e) {
            return (
                (t = X(t, "bVisible")), -1 !== (e = j.inArray(e, t)) ? e : null
            );
        }
        function m(t) {
            var n = 0;
        ...
        function D(t, e, n, a) {
            ...
            return (
                ...
                (!n && t.oFeatures.bDeferRender) || et(t, r, n, a),
                r
            );
        }
        function q(n, t) {
            var a;
            return (t = t instanceof j ? t : j(t)).map(function (t, e) {
                return (a = tt(n, e)), D(n, a.data, e, a.cells);
            });
        }
        function S(t, e, n, a) {
        ...
        function Q(n, a, t, e) {
            ...
            } else o._aData = tt(n, o, e, e === R ? R : o._aData).data;
            if (
                ((o._aSortData = null),
                (o._aFilterData = null),
                (i = n.aoColumns),
        ...
        function tt(t, e, n, a) {
            function r(t, e) {
                ...
                "string" == typeof t &&
                    -1 !== (n = t.indexOf("@")) &&
                    ((n = t.substring(n + 1)), g(t)(a, e.getAttribute(n)));
            }
            function o(t) {
                (n !== R && n !== c) ||
                    ((i = f[c]),
            ...
            if (u)
                for (; u; ) {
                    ...
                    ("TD" != h && "TH" != h) || (o(u), s.push(u)),
                        (u = u.nextSibling);
                }
            else for (u = 0, h = (s = e.anCells).length; u < h; u++) o(s[u]);
            return (
            ...
            if (null === c.nTr) {
                for (
                    ...
                    var c,
                        f = t.aoColumns[s];
                    ((c = (r = !n)
                        ? y.createElement(f.sCellType)
                        : a[s])._DT_CellIndex = { row: e, column: s }),
                        i.push(c),
                        (!r &&
                            ((!f.mRender && f.mData === s) ||
                                (j.isPlainObject(f.mData) &&
                                    f.mData._ === s + ".display"))) ||
                            (c.innerHTML = S(t, e, s, "display")),
                        f.sClass && (c.className += " " + f.sClass),
                        f.bVisible && !n
                            ? l.appendChild(c)
                            : !f.bVisible && n && c.parentNode.removeChild(c),
                        f.fnCreatedCell &&
                ...
                C(t, "aoRowCreatedCallback", null, [l, o, e, i]);
            }
        }
        function nt(t, e) {
            var n = e.nTr,
            ...
            n &&
                ...
                a.DT_RowClass &&
                    ...
                    (e.__rowc = e.__rowc ? Ie(e.__rowc.concat(t)) : t),
                    j(n)
        ...
        function at(t) {
            for (
                var e,
                    n = t.nTHead,
                    a = t.nTFoot,
                    r = 0 === j("th, td", n).length,
                    o = t.oClasses,
                    i = t.aoColumns,
                    l = (r && (e = j("<tr/>").appendTo(n)), 0),
                    s = i.length;
                l < s;
                l++
            ) {
                var u = i[l],
                    c = j(u.nTh).addClass(u.sClass);
                r && c.appendTo(e),
                    t.oFeatures.bSort &&
                        (c.addClass(u.sSortingClass),
                        !1 !== u.bSortable &&
                            (c
            ...
            if (
                (r && it(t.aoHeader, n),
                j(n).children("tr").children("th, td").addClass(o.sHeaderTH),
                j(a).children("tr").children("th, td").addClass(o.sFooterTH),
                null !== a)
            )
                for (s = (t = t.aoFooter[(l = 0)]).length; l < s; l++)
                    ((u = i[l]).nTf = t[l].cell),
                        u.sClass && j(u.nTf).addClass(u.sClass);
        }
        function rt(t, e, n) {
            var a,
                r = [],
            ...
            if (e) {
                ...
                for (var l = 0, s = e.length; l < s; l++) {
                    for (
                        r[l] = e[l].slice(), r[l].nTr = e[l].nTr, a = i - 1;
                        0 <= a;
                        a--
                    )
                        t.aoColumns[a].bVisible || n || r[l].splice(a, 1);
                    o.push([]);
                }
                for (l = 0, s = r.length; l < s; l++) {
                    if ((t = r[l].nTr))
                        for (; (a = t.firstChild); ) t.removeChild(a);
                    for (a = 0, e = r[l].length; a < e; a++) {
                        var u = (i = 1);
                        if (o[l][a] === R) {
                            for (
                                t.appendChild(r[l][a].cell), o[l][a] = 1;
                                r[l + i] !== R &&
                                r[l][a].cell == r[l + i][a].cell;
                            ...
                            for (
                                ;
                                r[l][a + u] !== R &&
                                r[l][a].cell == r[l][a + u].cell;

                            ) {
                                for (n = 0; n < i; n++) o[l + n][a + u] = 1;
                                u++;
                            }
                            j(r[l][a].cell)
                                .attr("rowspan", i)
        ...
        function c(t, e) {
            var n = "ssp" == x(t);
            if (
                ((a = t.iInitDisplayStart) !== R &&
                    -1 !== a &&
                    ((t._iDisplayStart =
                        !n && a >= t.fnRecordsDisplay() ? 0 : a),
                    (t.iInitDisplayStart = -1)),
                (n = C(t, "aoPreDrawCallback", "preDraw", [t])),
                -1 !== j.inArray(!1, n))
            )
                p(t, !1);
            else {
                ...
                if (((t.bDrawing = !0), t.bDeferLoading))
                    (t.bDeferLoading = !1), t.iDraw++, p(t, !1);
                else if (l) {
                    if (!t.bDestroying && !e) return void ut(t);
                } else t.iDraw++;
                if (0 !== s.length)
                    for (
                        e = l ? t.aoData.length : c, i = l ? 0 : u;
                        i < e;
                        i++
                    ) {
                        var f,
                            l = s[i],
                            d = t.aoData[l],
                            h = (null === d.nTr && et(t, l), d.nTr);
                        0 !== o &&
                            ((f = a[r % o]),
                            d._sRowStripe != f &&
                                (j(h).removeClass(d._sRowStripe).addClass(f),
                                (d._sRowStripe = f))),
                            C(t, "aoRowCallback", null, [h, d._aData, r, i, l]),
                            n.push(h),
                            r++;
                    }
                else
        ...
        function ot(t) {
            ...
            for (
                ...
                else if ("l" == i && a.bPaginate && a.bLengthChange) o = At(t);
                else if ("f" == i && a.bFilter) o = ht(t);
                else if ("r" == i && a.bProcessing) o = jt(t);
                else if ("t" == i) o = Pt(t);
                else if ("i" == i && a.bInfo) o = _t(t);
                else if ("p" == i && a.bPaginate) o = Ft(t);
                else if (0 !== I.ext.feature.length)
                    for (c = 0, s = (l = I.ext.feature).length; c < s; c++)
                        if (i == l[c].cFeature) {
                            o = l[c].fnInit(t);
                            break;
                        }
        ...
        function it(t, e) {
            (e = j(e).children("tr")), t.splice(0, t.length);
            ...
            for (n = 0, a = e.length; n < a; n++)
                for (var r = e[n], o = r.firstChild; o; ) {
                    if (
                        ...
                        for (
                            var i =
                                    (i = +o.getAttribute("colspan")) &&
                                    0 !== i &&
                                    1 !== i
                                        ? i
                                        : 1,
                                l =
                                    (l = +o.getAttribute("rowspan")) &&
                                    0 !== l &&
                                    1 !== l
                                        ? l
                                        : 1,
        ...
        function st(a, t, n) {
            ...
            j.isPlainObject(s) &&
                ...
                (t = "function" == typeof i && l ? l : j.extend(!0, t, l)),
                delete s.data),
                (l = {
                    data: t,
                    success: e,
                ...
                a.fnServerData
                    ...
                    ? (a.jqXHR = j.ajax(
                          j.extend(l, { url: s || a.sAjaxSource })
                      ))
                    : "function" == typeof s
                    ? (a.jqXHR = s.call(u, t, e, a))
                    : ((a.jqXHR = j.ajax(j.extend(l, s))), (s.data = i));
        }
        function ut(e) {
            e.iDraw++,
                p(e, !0),
        ...
        function ct(t) {
            ...
            return (
                ...
                r.bSort &&
                    (j.each(s, function (t, e) {
                        f.order.push({ column: e.col, dir: e.dir }),
                            n("iSortCol_" + t, e.col),
                            n("sSortDir_" + t, e.dir);
                    }),
                    n("iSortingCols", s.length)),
                null === (e = I.ext.legacy.ajax)
                    ? t.sAjaxSource
                        ? l
                        : f
                    : e
        ...
        function dt(t, e, n) {
            if (
                ((t =
                    j.isPlainObject(t.ajax) && t.ajax.dataSrc !== R
                        ? t.ajax.dataSrc
                        : t.sAjaxDataProp),
                !n)
            )
        ...
        function bt(t, e, n, a, r, o) {
            if ("" !== e) {
                var i = [],
                    l = t.aiDisplay;
                for (a = St(e, a, r, o), r = 0; r < l.length; r++)
        ...
        function mt(t, e, n, a, r, o) {
            ...
            var i = t.oPreviousSearch.sSearch,
                l = t.aiDisplayMaster,
                s = ((o = []), 0 !== I.ext.search.length && (n = !0), yt(t));
            if (e.length <= 0) t.aiDisplay = l.slice();
            else {
                for (
                    (s ||
                        n ||
        ...
        function yt(t) {
            for (
                var e = t.aoColumns, n = !1, a = 0, r = t.aoData.length;
                a < r;
                a++
            ) {
                var o = t.aoData[a];
                    ...
                    for (var i = [], n = 0, l = e.length; n < l; n++) {
                        ...
                        s.bSearchable
                            ...
                            s.indexOf &&
                                -1 !== s.indexOf("&") &&
                                ((je.innerHTML = s),
                                (s = Pe ? je.textContent : je.innerText)),
        ...
        function _t(t) {
            ...
            return (
                n ||
                    (t.aoDrawCallback.push({ fn: Tt, sName: "information" }),
        ...
        function Ct(n) {
            ...
            if (n.bInitialised) {
                ...
                for (var o = 0, e = t.length; o < e; o++) {
                    var i = t[o];
                    i.sWidth && (i.nTh.style.width = M(i.sWidth));
                }
                C(n, null, "preInit", [n]),
                    l(n),
                    ("ssp" == (t = x(n)) && !r) ||
        ...
        function At(a) {
            ...
            var s = j("<div><label/></div>").addClass(t.sLength);
            return (
                        ...
                        fn: function (t) {
                            if (s)
                                for (
                                    ...
                                    Zt(t, "pageButton")(t, u.p[r], r, a, e, n);
                            else l.fnUpdate(t, i);
                        },
                        sName: "pagination",
                    })),
        ...
        function Pt(t) {
            ...
            var a = n.sX,
                ...
                f =
                    (c.length || (c = null),
                    (s = j("<div/>", { class: o.sScrollWrapper })
                        .append(
                            j("<div/>", { class: o.sScrollHead })
                                .css({
                                    overflow: "hidden",
                                    position: "relative",
                                    border: 0,
                                ...
                                .append(
                                    j("<div/>", { class: o.sScrollHeadInner })
                                        .css({
            ...
            return (
                a &&
                    j(o).on("scroll.DT", function (t) {
                        (t = this.scrollLeft),
                            (f.scrollLeft = t),
                            c && (d.scrollLeft = t);
                    }),
                j(o).css("max-height", r),
                n.bCollapse || j(o).css("height", r),
                (t.nScrollHead = f),
                (t.nScrollBody = o),
                (t.nScrollFoot = d),
                t.aoDrawCallback.push({ fn: Rt, sName: "scrolling" }),
                s[0]
            );
        }
        function Rt(n) {
            ...
            var a,
                ...
                g = j(p),
                b = p.style,
                m = j(n.nScrollFoot).children("div"),
                S = m.children("table"),
                y = j(n.nTHead),
                v = j(n.nTable),
                D = v[0],
                _ = D.style,
                T = n.nTFoot ? j(n.nTFoot) : null,
                w = n.oBrowser,
                C = w.bScrollOversize,
                x = (k(n.aoColumns, "nTh"), []),
                I = [],
            ...
            n.scrollBarVis !== L && n.scrollBarVis !== R
                ...
                : ((n.scrollBarVis = L),
                  ...
                  "" === i
                      ? ((_.width = "100%"),
                        C &&
                            ...
                            (_.width = M(v.outerWidth() - u)),
                        (c = v.outerWidth()))
                      : "" !== l && ((_.width = M(l)), (c = v.outerWidth())),
                  H(t, L),
                  H(function (t) {
                      var e = P.getComputedStyle
                          ? P.getComputedStyle(t).width
                          : M(j(t).width());
                  ...
                  T &&
                      (H(t, r),
                      H(function (t) {
                          F.push(t.innerHTML), I.push(M(j(t).css("width")));
                      }, r),
                      H(function (t, e) {
                          t.style.width = I[e];
                      }, e),
                  ...
                  H(function (t, e) {
                      (t.innerHTML =
                          '<div class="dataTables_sizing">' + A[e] + "</div>"),
                  ...
                  Math.round(v.outerWidth()) < Math.round(c)
                      ? ((e =
                  ...
                  (b.width = M(e)),
                  (f.width = M(e)),
                  T && (n.nScrollFoot.style.width = M(e)),
                  !s && C && (b.height = M(D.offsetHeight + u)),
                  (i = v.outerWidth()),
                  (h[0].style.width = M(i)),
                  (d.width = M(i)),
                  (l =
                      v.height() > p.clientHeight ||
                      "scroll" == g.css("overflow-y")),
        ...
        function Ot(t) {
            var e,
                ...
                p = h.bScrollOversize;
            for (
                (e = n.style.width) && -1 !== e.indexOf("%") && (c = e), e = 0;
                e < s.length;
                e++
            ) {
                var g = a[s[e]];
                null !== g.sWidth &&
                    ((g.sWidth = Nt(g.sWidthOrig, f)), (d = !0));
            }
            if (p || (!d && !o && !r && l == m(t) && l == u.length))
                for (e = 0; e < l; e++)
                    null !== (s = N(t, e)) &&
                        (a[s].sWidth = M(u.eq(e).width()));
            else {
                (l = j(n).clone().css("visibility", "hidden").removeAttr("id"))
                    .find("tbody tr")
                    .remove();
                var b = j("<tr/>").appendTo(l.find("tbody"));
                for (
                    l.find("thead, tfoot").remove(),
                        l
                            .append(j(t.nTHead).clone())
                            .append(j(t.nTFoot).clone()),
                        l.find("tfoot th, tfoot td").css("width", ""),
                        u = lt(t, l.find("thead")[0]),
                        e = 0;
                    e < s.length;
                    e++
                )
                ...
                for (
                    ...
                    (i = (f = j(u[e])).outerWidth() - f.width()),
                        (r += f =
                            h.bBounding
                                ? Math.ceil(u[e].getBoundingClientRect().width)
                                : f.outerWidth()),
                        (a[s[e]].sWidth = M(f - i));
                (n.style.width = M(r)), g.remove();
            }
            c && (n.style.width = M(c)),
                (!c && !o) ||
                    t._reszEvt ||
        ...
        function Ht(t, e) {
            ...
            return a.nTr
                ? a.anCells[e]
                : j("<td/>").html(S(t, n, e, "display"))[0];
        }
        function Mt(t, e) {
            for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)
                (n = (n = (n = S(t, o, e, "display") + "").replace(
                    Re,
                    ""
                )).replace(/&nbsp;/g, " ")).length > a &&
                    ((a = n.length), (r = o));
        ...
        function _(t) {
            ...
            for (
                ...
                for (
                    var l = o[t][0], a = 0, r = (i = n[l].aDataSort).length;
                    a < r;
                    a++
                ) {
                    var s = i[a],
                        u = n[s].sType || "string";
                    o[t]._idx === R &&
                        (o[t]._idx = j.inArray(o[t][1], n[s].asSorting)),
                        e.push({
                            src: l,
                            col: s,
                            dir: o[t][1],
                            index: o[t]._idx,
                            type: u,
                            formatter: I.ext.type.order[u + "-pre"],
                        });
                }
            return e;
        }
        function Et(t) {
            for (
                ...
                var o = d[a];
                o.formatter && e++, Ut(t, o.col);
            }
            if ("ssp" != x(t) && 0 !== d.length) {
                    ...
                    ? n.sort(function (t, e) {
                          for (
                              ...
                              var i = d[o],
                                  l = a[i.col],
                                  s = r[i.col];
                              if (0 !== (l = l < s ? -1 : s < l ? 1 : 0))
                                  return "asc" === i.dir ? l : -l;
                          }
                          return (l = u[t]) < (s = u[e]) ? -1 : s < l ? 1 : 0;
                      })
                    : n.sort(function (t, e) {
                          for (
                              var n = d.length,
        ...
        function Wt(t, e, n, a) {
            function r(t, e) {
                var n = t._idx;
                return (n = n === R ? j.inArray(t[1], i) : n) + 1 < i.length
                    ? n + 1
                    : e
                    ? null
                    : 0;
            ...
            "number" == typeof o[0] && (o = t.aaSorting = [o]),
                n && t.oFeatures.bSortMulti
                    ? -1 !== (n = j.inArray(e, k(o, "0")))
                        ? null ===
                          (e =
                              null === (e = r(o[n], !0)) && 1 === o.length
                                  ? 0
                                  : e)
                            ? o.splice(n, 1)
        ...
        function Bt(t) {
            ...
            if (o.bSort && o.bSortClasses) {
                for (o = 0, e = n.length; o < e; o++) {
                    var i = n[o].src;
                    j(k(t.aoData, "anCells", i)).removeClass(
                        a + (o < 2 ? o + 1 : 3)
                    );
                }
                for (o = 0, e = r.length; o < e; o++)
                    (i = r[o].src),
                        j(k(t.aoData, "anCells", i)).addClass(
                            a + (o < 2 ? o + 1 : 3)
                        );
            }
            t.aLastSort = r;
        ...
        function Ut(t, e) {
            var n,
                a = t.aoColumns[e],
                r = I.ext.order[a.sSortDataType];
            r && (n = r.call(t.oInstance, t, e, b(t, e)));
            for (
                var o,
                    i = I.ext.type.order[a.sType + "-pre"],
                    l = 0,
                    s = t.aoData.length;
                l < s;
                l++
        ...
        function Jt(n, t, e) {
            var a,
                ...
                o =
                    ((n._bLoadingState = !0),
                    n._bInitComplete ? new I.Api(n) : null);
            if (t && t.time) {
                var i = C(n, "aoStateLoadParams", "stateLoadParams", [n, t]);
                if (-1 !== j.inArray(!1, i)) n._bLoadingState = !1;
                else if (
                    0 < (i = n.iStateDuration) &&
                    t.time < +new Date() - 1e3 * i
                )
                    n._bLoadingState = !1;
                    ...
                    if (
                        ...
                        t.start !== R &&
                            (null === o
                                ...
                                : Lt(n, t.start / n._iDisplayLength)),
                        t.order !== R &&
                            ((n.aaSorting = []),
                            j.each(t.order, function (t, e) {
                                n.aaSorting.push(
                                    e[0] >= r.length ? [0, e[1]] : e
                                );
                            })),
                        t.search !== R &&
                            j.extend(n.oPreviousSearch, Dt(t.search)),
                        t.columns)
                    ) {
                        for (i = 0, a = t.columns.length; i < a; i++) {
                            var l = t.columns[i];
                            l.visible !== R &&
                                (o
        ...
        function qt(t) {
            var e = I.settings;
            return -1 !== (t = j.inArray(t, k(e, "nTable"))) ? e[t] : null;
        }
        function E(t, e, n, a) {
            if (
                ((n =
        ...
        function Zt(t, e) {
            t = t.renderer;
            var n = I.ext.renderer[e];
            return j.isPlainObject(t) && t[e]
                ? n[t[e]] || n._
        ...
        function Kt(t, e) {
            var n = We.numbers_length,
                a = Math.floor(n / 2);
            return (
                e <= n
                    ? (t = f(0, e))
                    : t <= a
                    ? ((t = f(0, n - 2)).push("ellipsis"), t.push(e - 1))
                    : (e - 1 - a <= t
                          ? (t = f(e - (n - 2), e))
                          : ((t = f(t - a + 2, t + a - 1)).push("ellipsis"),
                            t.push(e - 1)),
        ...
        function Qt(n) {
            j.each(
                ...
                function (t, e) {
                    (d.type.order[t + n + "-pre"] = e),
                        t.match(/^html\-/) &&
                            (d.type.search[t + n] = d.type.search.html);
                }
            );
        }
        ...
        function ee(t, e, n) {
            if (P.moment) {
                ...
                if (
                    !(a = e
                        ? P.luxon.DateTime.fromFormat(t, e)
                        : P.luxon.DateTime.fromISO(t)).isValid
                )
                    return null;
                a.setLocale(n);
            } else
        ...
        function ne(s) {
            return function (a, r, o, i) {
                ...
                return (
                    I.ext.type.order[l] ||
                        (I.ext.type.detect.unshift(function (t) {
                            return t === l && l;
                        }),
                        (I.ext.type.order[l + "-asc"] = function (t, e) {
                        ...
                        (I.ext.type.order[l + "-desc"] = function (t, e) {
                            return (t = t.valueOf()) === (e = e.valueOf())
                                ? 0
                                : e < t
                                ? -1
        ...
        function ae(e) {
            return function () {
                var t = [qt(this[I.ext.iApiIndex])].concat(
        ...
        function ce(t, e) {
            ...
            var n = j.map(e, function (t, e) {
                return t.nTable;
            });
            return j(n)
                .filter(t)
                .map(function (t) {
                    return (t = j.inArray(this, n)), e[t];
                })
                .toArray();
        }
        function fe(a, r, t) {
            ...
            t &&
                ...
                "ssp" == x(a)
                    ...
                    : (p(a, !0),
                      ...
                      st(a, [], function (t) {
                          Z(a);
                          for (var e = 0, n = (t = dt(a, t)).length; e < n; e++)
                              D(a, t[e]);
                          l(a, r), p(a, !1);
                      }));
        }
        function de(t, e, n, a, r) {
            ...
            for (
                ...
                for (
                    ...
                    (o = n("string" == typeof u[c] ? u[c].trim() : u[c])) &&
                        o.length &&
                        (l = l.concat(o));
            if ((t = d.selector[t]).length)
                for (s = 0, i = t.length; s < i; s++) l = t[s](a, r, l);
            return Ie(l);
        }
        function he(t) {
            return (
                ...
                if (Array.isArray(t) || t instanceof j)
                    ...
                    t.nodeName && "tr" === t.nodeName.toLowerCase()
                        ...
                        : ((n = j("<tr><td></td></tr>").addClass(e)),
                          (j("td", n).addClass(e).html(t)[0].colSpan = m(r)),
                          i.push(n[0]));
            }
            var i = [];
            o(e, n),
        ...
        function be(t, e) {
            ...
            i.length &&
                t.length &&
                (n = i[0].aoData[t[0]])._details &&
                ((n._detailsShow = e)
                    ? (n._details.insertAfter(n.nTr),
                      j(n.nTr).addClass("dt-hasChild"))
                    : (n._details.detach(),
                      j(n.nTr).removeClass("dt-hasChild")),
                C(i[0], null, "childRow", [e, t.row(t[0])]),
                (r = i[0]),
                (a = new F(r)),
                (o = r.aoData),
                a.off(
                ...
                0 < k(o, "_details").length &&
                    (a.on("draw.dt.DT_details", function (t, e) {
                        r === e &&
                            a
                                .rows({ page: "current" })
                                .eq(0)
        ...
        function me(t, e, n, a, r) {
            (n = []), (a = 0);
            for (var o = r.length; a < o; a++) n.push(S(t, r[a], e));
            return n;
        }
        function Se(t, e, n, a) {
            return 0 === t || (t && "-" !== t)
                ? ((t = e ? xe(t, e) : t).replace &&
                      (n && (t = t.replace(n, "")),
                      a && (t = t.replace(a, ""))),
                  +t)
                : -1 / 0;
        ...
        var d,
            ...
            t,
            I = function (t, b) {
                if (this instanceof I) return j(t).DataTable(b);
                (b = t),
                    (this.$ = function (t, e) {
                    ...
                    (this.api = function (t) {
                        return new F(t ? qt(this[d.iApiIndex]) : this);
                    }),
                    (this.fnAddData = function (t, e) {
                        ...
                        return (
                            (t = (
                                Array.isArray(t) &&
                                (Array.isArray(t[0]) || j.isPlainObject(t[0]))
                                    ? n.rows
                                    : n.row
                            ).add(t)),
                            (e !== R && !e) || n.draw(),
                    ...
                    (this.fnFilter = function (t, e, n, a, r, o) {
                        (r = this.api(!0)),
                            (null === e || e === R ? r : r.column(e)).search(
                                t,
                                n,
                                a,
                                o
                    ...
                    this.each(function () {
                        ...
                        if ("table" != this.nodeName.toLowerCase())
                            ...
                            W(e),
                                $(e.column),
                                v(e, e, !0),
                                v(e.column, e.column, !0),
                                v(e, j.extend(a, i.data()), !0);
                            for (
                                var n = I.settings, r = 0, l = n.length;
                                r < l;
                                r++
                            ) {
                                var s = n[r];
                            ...
                            (null !== t && "" !== t) ||
                                (this.id = t =
                                    "DataTables_Table_" + I.ext._unique++);
                            var c,
                                f = j.extend(!0, {}, I.models.oSettings, {
                                ...
                                d =
                                    ...
                                    T(f.oLanguage, a, "fnInfoCallback"),
                                    w(
                                        f,
                                        "aoDrawCallback",
                                        a.fnDrawCallback,
                                    ...
                                    f.oClasses),
                                h =
                                    (j.extend(d, I.ext.classes, a.oClasses),
                                    i.addClass(d.sTable),
                                    f.iInitDisplayStart === R &&
                                        ((f.iInitDisplayStart =
                                            a.iDisplayStart),
                            ...
                            if (
                                (-1 !==
                                    ...
                                    (j("tbody tr", this).removeClass(
                                        t.join(" ")
                                    ),
                                    (f.asDestroyStripes = t.slice())),
                                (t = []),
                                0 !==
                                    (n = this.getElementsByTagName("thead"))
                                        .length &&
                                    (it(f.aoHeader, n[0]), (t = lt(f))),
                                null === a.aoColumns)
                            )
                            ...
                            for (r = 0, l = n.length; r < l; r++)
                                U(f, t ? t[r] : null);
                            J(f, a.aoColumnDefs, n, function (t, e) {
                                V(f, t, e);
                            }),
                                p.length &&
                                    ((c = function (t, e) {
                                ...
                                t = function () {
                                    if (a.aaSorting === R) {
                                        ...
                                        for (r = 0, l = t.length; r < l; r++)
                                            t[r][1] =
                                                f.aoColumns[r].asSorting[0];
                                    }
                                    Bt(f),
                                        g.bSort &&
                                            w(f, "aoDrawCallback", function () {
                                                var t, n;
                                                f.bSorted &&
                                                    ((t = _(f)),
                                                    (n = {}),
                                    ...
                                    var t = i
                                            ...
                                            .each(function () {
                                                this._captionSide =
                                                    j(this).css("caption-side");
                                            }),
                                        e = i.children("thead"),
                                        n =
                                            (0 === e.length &&
                                                (e = j("<thead/>").appendTo(i)),
                                            (f.nTHead = e[0]),
                                            i.children("tbody"));
                                    if (
                                        (0 === n.length &&
                                            (n = j("<tbody/>").insertAfter(e)),
                                        (f.nTBody = n[0]),
                                        0 ===
                                            (e =
                                                0 ===
                                        ...
                                        0 === e.children().length
                                            ...
                                            : 0 < e.length &&
                                              ((f.nTFoot = e[0]),
                                              it(f.aoFooter, f.nTFoot)),
                                        a.aaData)
                                    )
                                        for (r = 0; r < a.aaData.length; r++)
                                            D(f, a.aaData[r]);
                                    else
                                        (!f.bDeferLoading && "dom" != x(f)) ||
                                            q(f, j(f.nTBody).children("tr"));
                                    (f.aiDisplay = f.aiDisplayMaster.slice()),
                                        !(f.bInitialised = !0) === o && Ct(f);
                                };
                            w(f, "aoDrawCallback", Vt, "state_save"),
                                a.bStateSave
                                    ? ((g.bStateSave = !0), Xt(f, 0, t))
                                    : t();
                        }
                    }),
                    (m = null),
            ...
            xe = function (t, e) {
                return (
                    ve[e] || (ve[e] = new RegExp(Le(e), "g")),
                    "string" == typeof t && "." !== e
                        ? t.replace(/\./g, "").replace(ve[e], ".")
                        : t
                );
            },
            k = function (t, e, n) {
            ...
            Ae = function (t, e) {
                if (Array.isArray(e))
                    for (var n = 0; n < e.length; n++) Ae(t, e[n]);
                else t.push(e);
                return t;
            },
            a =
                ...
                Array.prototype.includes || (Array.prototype.includes = ue),
                ...
                String.prototype.includes || (String.prototype.includes = ue),
                (I.util = {
                    ...
                    escapeRegex: function (t) {
                        return t.replace(we, "\\$1");
                    },
                    set: function (a) {
                        if (j.isPlainObject(a)) return I.util.set(a._);
            ...
            He =
                ...
                j.extend(F.prototype, {
                    ...
                    eq: function (t) {
                        var e = this.context;
                        return e.length > t ? new F(e[t], this[t]) : null;
                    },
                    filter: function (t) {
                        var e = [];
                    ...
                    iterator: function (t, e, n, a) {
                        for (
                            ...
                            var c = new F(i[s]);
                            if ("table" === e) {
                                var f = n.call(c, i[s], s);
                                f !== R && o.push(f);
                            } else if ("columns" === e || "rows" === e)
                                (f = n.call(c, i[s], this[s], s)) !== R &&
                                    o.push(f);
                            else if (
                                "column" === e ||
                                "column-rows" === e ||
                    ...
                    unique: function () {
                        return new F(this.context, Ie(this));
                    },
                    unshift: r.unshift,
                }),
                (F.extend = function (t, e, n) {
                    if (n.length && e && (e instanceof F || e.__dt_wrapper))
                ...
                e("tables()", function (t) {
                    return t !== R && null !== t
                        ? new F(ce(t, this.context))
                        : this;
                }),
                e("table()", function (t) {
                    var e = (t = this.tables(t)).context;
                    return e.length ? new F(e[0]) : t;
                }),
                ...
                function (t, e) {
                    var n = [],
                        ...
                        i = e.order;
                    if (((e = e.page), "ssp" == x(t)))
                        return "removed" === o ? [] : f(0, r.length);
                    if ("current" == e)
                        for (
                            i = t._iDisplayStart, t = t.fnDisplayEnd();
                            i < t;
                            i++
                        )
                            n.push(a[i]);
            ...
            Me =
                        ...
                        this.iterator("row", function (t, e, n) {
                            for (
                                ...
                                var s = r[i],
                                    u = s.anCells;
                                if (
                                    (null !== s.nTr && (s.nTr._DT_RowIndex = i),
                                    null !== u)
                                )
                                    for (s = 0, a = u.length; s < a; s++)
                                        u[s]._DT_CellIndex.row = i;
                            }
                            K(t.aiDisplayMaster, e),
                                K(t.aiDisplay, e),
                                K(c[n], e, !1),
                                0 < t._iRecordsDisplay && t._iRecordsDisplay--,
                                zt(t),
                                (e = t.rowIdFn(o._aData)) !== R &&
                                    delete t.aIds[e];
                        }),
                        this.iterator("table", function (t) {
                ...
                e("rows.add()", function (o) {
                    var t = this.iterator(
                            ...
                            function (t) {
                                for (
                                    var e = [], n = 0, a = o.length;
                                    n < a;
                                    n++
                                ) {
                                    var r = o[n];
                                    r.nodeName &&
                                    "TR" === r.nodeName.toUpperCase()
                                        ? e.push(q(t, r)[0])
                                        : e.push(D(t, r));
                                }
                                return e;
                ...
                j(y).on("plugin-init.dt", function (t, e) {
                    (t = new F(e)).on("stateSaveParams", function (t, e, n) {
                    ...
                    n &&
                        ...
                        t
                            .rows(
                                j.map(n.childRows, function (t) {
                                    return t.replace(/:/g, "\\:");
                                })
                            )
                            .every(function () {
                                C(e, null, "requestChild", [this]);
                            });
                }),
            ...
            Ee = function (t, e) {
                ...
                n.length &&
                    ...
                    (t._detailsShow = R),
                    (t._details = R),
                    j(t.nTr).removeClass("dt-hasChild"),
                    Me(n));
            },
            ke =
            ...
            We =
                ...
                t("columns().visible()", "column().visible()", function (s, n) {
                    var e = this,
                        t = this.iterator("column", function (t, e) {
                            ...
                            if (s !== R && n.bVisible !== s) {
                                ...
                                else j(k(t.aoData, "anCells", e)).detach();
                                n.bVisible = s;
                            }
                        });
                    return (
                ...
                e("cells()", function (g, t, b) {
                    if (
                        ...
                        return this.iterator("table", function (t) {
                            ...
                            var n, e, a, r, o, i, l, s, u, c, f, d, h, p;
                        });
                    var n,
                        a,
                        r,
                    ...
                    return (
                        ...
                        j.extend(e.selector, { cols: t, rows: g, opts: b }),
                        e
                    );
                }),
                ...
                (I.isDataTable = I.fnIsDataTable =
                    function (t) {
                        ...
                        return (
                            t instanceof I.Api ||
                            (j.each(I.settings, function (t, e) {
                                t = e.nScrollHead
                                    ? j("table", e.nScrollHead)[0]
                                    : null;
                                var n = e.nScrollFoot
                                    ? j("table", e.nScrollFoot)[0]
                                    : null;
                                (e.nTable !== a && t !== a && n !== a) ||
                                    (r = !0);
                            }),
                    ...
                    function (e) {
                        var t = !1,
                            n =
                                (j.isPlainObject(e) &&
                                    ((t = e.api), (e = e.visible)),
                                j.map(I.settings, function (t) {
                                    if (!e || j(t.nTable).is(":visible"))
                                        return t.nTable;
                                }));
                        return t ? new F(n) : n;
                    }),
                (I.camelToHungarian = v),
                e("$()", function (t, e) {
                    return (
                        (e = this.rows(e).nodes()),
                        (e = j(e)),
                        j([].concat(e.filter(t).toArray(), e.find(t).toArray()))
                    );
                }),
                ...
                e("settings()", function () {
                    return new F(this.context, this.context);
                }),
                e("init()", function () {
                    var t = this.context;
                    ...
                    return (
                        ...
                        this.iterator("table", function (e) {
                            var n,
                                ...
                                r = j(r),
                                s = j(e.nTableWrapper),
                                u = j.map(e.aoData, function (t) {
                                    return t.nTr;
                                });
                            (e.bDestroying = !0),
                                C(e, "aoDestroyCallback", "destroy", [e]),
                                c || new F(e).columns().visible(!0),
                                s.off(".DT").find(":not(tbody *)").off(".DT"),
                                j(P).off(".DT-" + e.sInstance),
                                a != o.parentNode &&
                                ...
                                (e.aaSortingFixed = []),
                                Bt(e),
                                j(u).removeClass(e.asStripeClasses.join(" ")),
                                j("th, td", o).removeClass(
                                    t.sSortable +
                                        " " +
                                        t.sSortableAsc +
                                        " " +
                                ...
                                -1 !== (t = j.inArray(e, I.settings)) &&
                                    I.settings.splice(t, 1);
                        })
                    );
                }),
                ...
                e("i18n()", function (t, e, n) {
                    ...
                    return (
                        (t = A(t)(a.oLanguage)) === R && (t = e),
                        (t =
                            n !== R && j.isPlainObject(t)
                                ? t[n] !== R
                                    ? t[n]
                                    : t._
                                : t).replace("%d", n)
                ...
                (I.defaults = {
                    ...
                    oSearch: j.extend({}, I.models.oSearch),
                    sAjaxDataProp: "data",
                    sAjaxSource: null,
                    sDom: "lfrtip",
                    searchDelay: null,
            ...
            $e =
                ...
                j.extend(!0, I.ext.renderer, {
                    pageButton: {
                        _: function (s, t, u, e, c, f) {
                            function d(t, e) {
                                function n(t) {
                                    Lt(s, t.data.action, !0);
                                }
                                for (
                                    var a = g.sPageButtonDisabled,
                                        r = 0,
                                        o = e.length;
                                    r < o;
                                    r++
                ...
                j.extend(I.ext.type.detect, [
                    ...
                    function (t, e) {
                        return (!t || t instanceof Date || Te.test(t)) &&
                    ...
                    function (t, e) {
                        return (
                            (e = e.oLanguage.sDecimal),
                            oe(t, e, !0) ? "num-fmt" + e : null
                        );
                    },
                    function (t, e) {
                        return (
                            (e = e.oLanguage.sDecimal),
                            ie(t, e) ? "html-num" + e : null
                        );
                    },
                    function (t, e) {
                        return (
                            (e = e.oLanguage.sDecimal),
                            ie(t, e, !0) ? "html-num-fmt" + e : null
                        );
                    },
                    function (t, e) {
                        return h(t) ||
                ...
                j.extend(I.ext.type.search, {
                    html: function (t) {
                        return h(t)
                            ? t
                            : "string" == typeof t
                            ? t.replace(De, " ").replace(_e, "")
                            : "";
                    },
                    string: function (t) {
                        return !h(t) && "string" == typeof t
                            ? t.replace(De, " ")
                            : t;
                    },
                }),
                j.extend(d.type.order, {
                    "date-pre": function (t) {
        ...
        if (Intl)
            try {
                for (
                    ...
                    "group" === Ve[n].type
                        ? (Be = Ve[n].value)
                        : "decimal" === Ve[n].type && (Ue = Ve[n].value);
            } catch (t) {}
        return (
            (I.datetime = function (n, a) {
                ...
                (a = a || "en"),
                    I.ext.type.order[r] ||
                        ...
                        (I.ext.type.order[r + "-pre"] = function (t) {
                            return ee(t, n, a) || 0;
                        }));
            }),
            (I.render = {
                date: ne("toLocaleDateString"),
                datetime: ne("toLocaleString"),
                time: ne("toLocaleTimeString"),
                ...
                text: function () {
                    return { display: ye, filter: ye };
                },
            }),
            j.extend(I.ext.internal, {
                _fnExternApiFunc: ae,
                _fnBuildAjax: st,
                _fnAjaxUpdate: ut,
                _fnAjaxParameters: ct,
                _fnAjaxUpdateDraw: ft,
                _fnAjaxDataSrc: dt,
                _fnAddColumn: U,
                _fnColumnOptions: V,
                ...
                _fnDeleteIndex: K,
                _fnInvalidate: Q,
                _fnGetRowElements: tt,
                _fnCreateTr: et,
                _fnBuildHead: at,
                _fnDrawHead: rt,
                _fnDraw: c,
                _fnReDraw: l,
                _fnAddOptionsHtml: ot,
                _fnDetectHeader: it,
                _fnGetUniqueThs: lt,
                _fnFeatureHtmlFilter: ht,
                _fnFilterComplete: pt,
                _fnFilterCustom: gt,
                _fnFilterColumn: bt,
                _fnFilter: mt,
                ...
                _fnCalculateColumnWidths: Ot,
                _fnThrottle: Oe,
                _fnConvertToWidth: Nt,
                _fnGetWidestNode: Ht,
                ...
                _fnSortingClasses: Bt,
                _fnSortData: Ut,
                _fnSaveState: Vt,
                _fnLoadState: Xt,
                _fnImplementState: Jt,
                _fnSettingsFromNode: qt,
                _fnLog: E,
                _fnMap: T,
                _fnBindAction: Gt,
                _fnCallbackReg: w,
                _fnCallbackFire: C,
                _fnLengthOverflow: zt,
                _fnRenderer: Zt,
                _fnDataSource: x,
                _fnRowAttributes: nt,
                _fnExtend: Yt,
            ...
            (((j.fn.dataTable = I).$ = j).fn.dataTableSettings = I.settings),
            (j.fn.dataTableExt = I.ext),
